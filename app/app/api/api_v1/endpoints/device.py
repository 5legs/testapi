...
from app.models.device import Device, DeviceInCreate, DeviceInUpdate
...
def create_device(
    *,
    ...
    if authorized:
        ...
        if device:
            raise HTTPException(
                status_code=400, detail="The device already exists."
            )
...
def delete_device(
    ...
    if authorized:
        ...
        if not device:
            raise HTTPException(
                status_code=400, detail="The device does not exist."
            )
